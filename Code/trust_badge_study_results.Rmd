...
One missing value in `age_group`. This also exists from the point the data is read in. We'll keep the observation since there is nothing that indicates it isn't valid.
